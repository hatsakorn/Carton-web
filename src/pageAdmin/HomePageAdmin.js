            ...
            <div className=" w-8/12 h-96 pr-10 flex-row ">
              <div className="flex justify-evenly bg-white h-32 w-auto rounded-2xl shadow-2xl hover:scale-105 duration-300  mt-1">
                ...
                <div className="flex justify-between w-80 mt-5 text-blue-900">
                  <div className=" bg-blue-100 w-44 h-20 rounded-xl pl-3 shadow-2xl hover:bg-blue-200">
                    Date In:
                  ...
                  <div className="  bg-blue-100 w-44 h-20 rounded-xl pl-3 shadow-2xl hover:bg-blue-200 ml-5">
                    Date Out:
                    {showBox?.Items?.map((el) => {
                  ...
                  <div className="flex  bg-blue-100 w-52 h-20  rounded-xl pl-3 shadow-2xl hover:bg-blue-200 ml-5">
